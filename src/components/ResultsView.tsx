      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <div className="mb-8 grid grid-cols-3 gap-6 text-center">
                  ...
                  <div className="relative h-24 w-24 flex items-center justify-center">
                    <svg className="h-full w-full" viewBox="0 0 36 36">
                      ...
                      <path
                        ...
                        strokeDasharray={`${stats.raw.qualityScore}, 100`}
                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="3"
                ...
                <div className="flex flex-col items-center">
                  <div className="relative h-28 w-28 flex items-center justify-center">
                    <svg className="h-full w-full" viewBox="0 0 36 36">
                      ...
                      />
                      <path
                        className={isUserOptimal ? "text-green-500" : "text-blue-500"}
                        strokeDasharray={`${stats.user.qualityScore}, 100`}
                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="3"
                    ...
                    <div className="absolute flex flex-col items-center">
                      <span
                        className={`text-2xl font-bold ${
                          isUserOptimal ? "text-green-600" : "text-blue-600"
                        }`}
                      >
                        {stats.user.qualityScore}
                      </span>
                      <span className="text-[10px] text-slate-400 uppercase">
                        Score
                      </span>
                  ...
                  <div
                    className={`mt-2 text-xs font-semibold uppercase tracking-wide ${
                      isUserOptimal ? "text-green-700" : "text-blue-600"
                    }`}
                  >
                    Your Run
                  </div>
                ...
                <div className="flex flex-col items-center">
                  <div className="relative h-24 w-24 flex items-center justify-center">
                    <svg className="h-full w-full" viewBox="0 0 36 36">
                      ...
                      <path
                        ...
                        strokeDasharray={`${stats.ai.qualityScore}, 100`}
                        d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="3"
                  ...
                  <div className="mt-2 text-xs font-semibold text-purple-600 uppercase tracking-wide">
                    AI Baseline
                  </div>
                  {!isUserOptimal && scoreDiff > 0 && (
                    <div className="text-[10px] text-purple-500 mt-1 font-medium">
                      +{scoreDiff} pts available
                    </div>
                  )}
                </div>
              </div>
                ...
                <table className="w-full text-sm text-left">
                  <thead className="text-xs text-slate-500 uppercase bg-slate-50 border-b">
                    <tr>
                      ...
                      <th className="px-4 py-3 font-medium text-blue-700 bg-blue-50/50">
                        Your Run
                      </th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-slate-600">
                        {stats.raw.completionRate.toFixed(0)}%
                      </td>
                      <td className="px-4 py-3 font-semibold text-slate-900 bg-blue-50/30">
                        {stats.user.completionRate.toFixed(0)}%
                      </td>
                      <td className="px-4 py-3 text-slate-600">
                        {stats.ai.completionRate.toFixed(0)}%
                      </td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-medium text-slate-700 flex items-center">
                      ...
                      <td className="px-4 py-3 font-semibold text-slate-900 bg-blue-50/30">
                        {stats.user.dataRetention.toFixed(0)}%
                      </td>
                      <td className="px-4 py-3 text-slate-600">
                        {stats.ai.dataRetention.toFixed(0)}%
                      </td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-medium text-slate-700 flex items-center">
                      ...
                      <td className="px-4 py-3 text-red-500">
                        {stats.raw.duplicateRows}
                      </td>
                      <td className="px-4 py-3 font-semibold text-slate-900 bg-blue-50/30">
                        {stats.user.duplicateRows}
                      </td>
                      <td className="px-4 py-3 text-slate-600">
                        {stats.ai.duplicateRows}
                      </td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3 font-medium text-slate-700 flex items-center">
                      ...
                      <td className="px-4 py-3 text-slate-600">
                        {stats.raw.rowsRetained}
                      </td>
                      <td className="px-4 py-3 font-semibold text-slate-900 bg-blue-50/30">
                        {stats.user.rowsRetained}
                      </td>
                      <td className="px-4 py-3 text-slate-600">
                        {stats.ai.rowsRetained}
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between bg-purple-50 p-4 rounded-lg gap-4 border border-purple-100 shadow-sm">
                  <div className="flex items-center text-sm text-purple-800">
                    ...
                    <span>
                      ...
                      The AI applies advanced scaling & outlier handling.
                    </span>
                  </div>
                  <Button
              ...
              <div className="mt-6 bg-slate-50 p-4 rounded-lg text-xs text-slate-600 border border-slate-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                  <div className="flex justify-between border-b border-slate-200 pb-1">
                    ...
                    <span>
                      {run.config.imputationStrategy} vs{" "}
                      {aiConfigUsed?.imputationStrategy || "N/A"} (AI)
                    </span>
                  </div>
                  <div className="flex justify-between border-b border-slate-200 pb-1">
                    <span>Scaling:</span>
                    <span
                      className={
                        run.config.scaling !== "none"
                          ? "text-green-600 font-medium"
                          : ""
                      }
                    >
                      {run.config.scaling} vs{" "}
                      {aiConfigUsed?.scaling || "N/A"} (AI)
                    </span>
                  </div>
                  <div className="flex justify-between border-b border-slate-200 pb-1">
                    <span>Outliers:</span>
                    ...
                    >
                      {run.config.handleOutliers ? "Yes" : "No"} vs{" "}
                      {aiConfigUsed?.handleOutliers ? "Yes" : "No"} (AI)
                    </span>
                  </div>
                  <div className="flex justify-between border-b border-slate-200 pb-1">
                    <span>Encoding:</span>
              ...
              {run.aiSuggestions ? (
                <ReactMarkdown
                  ...
                  components={{
                    h1: ({ node, ...props }) => (
                      <h2
                        className="text-xl font-bold text-indigo-950 mt-6 mb-4 pb-2 border-b border-indigo-100 flex items-center"
                        {...props}
                      />
                    ),
                    h2: ({ node, ...props }) => (
                    ...
                    p: ({ node, ...props }) => (
                      <p
                        className="text-slate-600 leading-relaxed mb-4 text-sm md:text-base"
                        {...props}
                      />
                    ),
                    ul: ({ node, ...props }) => (
                      <ul
                        className="list-disc list-outside ml-5 space-y-2 mb-6 text-slate-600 marker:text-indigo-500"
                        {...props}
                      />
                    ),
                    ol: ({ node, ...props }) => (
                      <ol
                        className="list-decimal list-outside ml-5 space-y-2 mb-6 text-slate-600 marker:text-indigo-500"
                        {...props}
                      />
                    ),
                    ...
                    strong: ({ node, ...props }) => (
                      <strong
                        className="font-semibold text-slate-900 bg-indigo-50 px-1 py-0.5 rounded border border-indigo-100"
                        {...props}
                      />
                    ),
                    blockquote: ({ node, ...props }) => (
                      <blockquote
                        className="border-l-4 border-indigo-500 pl-4 py-2 my-4 bg-slate-50 text-slate-700 italic rounded-r"
                        {...props}
                      />
                    ),
                ...
                <div className="flex items-center justify-center h-full text-slate-400 italic">
                  <div className="animate-pulse mr-2">●</div> Generative
                  insights...
                </div>
              )}
            </div>
          ...
          <Card
            ...
            description="Python snippet using Scikit-Learn pipelines. Editable view."
          >
          ...
          <Card title="Transformation Summary">
            <ul className="space-y-3">
              <li className="flex items-center text-sm text-slate-700">
                ...
                />
                <span>
                  Imputation: <strong>{run.config.imputationStrategy}</strong>
                </span>
              </li>
              <li className="flex items-center text-sm text-slate-700">
                <CheckCircle
                ...
                />
                <span>
                  Scaling: <strong>{run.config.scaling}</strong>
                </span>
              </li>
              <li className="flex items-center text-sm text-slate-700">
                <CheckCircle
                ...
                />
                <span>
                  Encoding: <strong>{run.config.encoding}</strong>
                </span>
              </li>
              {run.config.handleOutliers && (
                <li className="flex items-center text-sm text-slate-700">
                  ...
                  />
                  <span>
                    Outliers: <strong>{run.config.outlierMethod}</strong>
                  </span>
                </li>
              )}
              {run.config.columnOverrides.length > 0 && (
                <li className="flex items-center text-sm text-slate-700">
                  ...
                  <span>
                    Overrides:{" "}
                    <strong>{run.config.columnOverrides.length} columns</strong>
                  </span>
                </li>
              )}
              {run.config.newFeatures.length > 0 && (
                <li className="flex items-center text-sm text-slate-700">
                  <CheckCircle
                    size={16}
                    className="text-purple-500 mr-2 shrink-0"
                  />
                  <span>
                    New Features:{" "}
                    <strong>{run.config.newFeatures.length} created</strong>
                  </span>
                </li>
              )}
            </ul>
